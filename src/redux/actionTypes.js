...
export const ADD_COMMITTEE_MEMBER = "ADD_COMMITTEE_MEMBER";
export const GET_ALL_COMMITEE_MEMBER = "GET_ALL_COMMITEE_MEMBER";
export const GET_ALL_COMMITEE = "GET_ALL_COMMITEE";
export const GET_COMMITEE_MEMBER = "GET_COMMITEE_MEMBER";
export const GET_MEMBER = "GET_MEMBER";

export const GET_STUDENT_DETAILS = "GET_STUDENT_DETAILS";
export const UPLOAD_PDF = "UPLOAD_PDF";
export const UPLOAD_FACULTY_PDF = "UPLOAD_FACULTY_PDF"
export const GET_PERTICULAR_STUDENT_DETAILS = "GET_PERTICULAR_STUDENT_DETAILS";

export const GET_PDF = "GET_PDF";
export const ATTENDANCE_PDF = "ATTENDANCE_PDF"