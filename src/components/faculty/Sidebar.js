    ...
    <div className="flex-[0.2]">
      <div className="space-y-8 overflow-y-scroll scrollbar-thin scrollbar-track-white scrollbar-thumb-gray-300 h-[33rem]">
        <div className="">
          ...
          <NavLink
            to="/faculty/studentdetail"
            className={({ isActive }) =>
              isActive ? isActiveStyle : isNotActiveStyle
            }>
            <PeopleOutlinedIcon className="" />
            <h1 className="font-normal">Student Details</h1>
          </NavLink>
          <NavLink
            to="/faculty/specificstudent"
            className={({ isActive }) =>
              isActive ? isActiveStyle : isNotActiveStyle
            }>
            <PermIdentityOutlinedIcon className="" />
            <h1 className="font-normal">Student Report</h1>
          </NavLink>
        </div>
        <div className="">
          <NavLink
          ...
          <NavLink
            to="/faculty/addcertificate"
            className={({ isActive }) =>
              isActive ? isActiveStyle : isNotActiveStyle
            }>
            <AddIcon className="" />
            <h1 className="font-normal">Add Achievements</h1>
          </NavLink>
        </div>
        <div className="">
          <NavLink
