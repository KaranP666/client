...
const Login = () => {
  return (
    <div
      ...
      style={{
        backgroundImage: `url("https://images.collegedunia.com/public/college_data/images/campusimage/1632393807218013144_2845057392414174_498500981460521056_n.jpg")`,
